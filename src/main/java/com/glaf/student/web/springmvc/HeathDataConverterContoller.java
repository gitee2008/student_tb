...
package com.glaf.student.web.springmvc;
...
import com.glaf.student.converter.HaizgMedicalExaminationConverter;
import com.glaf.student.converter.HaizgMedicalJoinExaminationConverter;
import com.glaf.student.converter.HaizgStudentConverter;
import com.glaf.student.domain.MedicalExamination;
...
@Controller("/student/dataConverter")
@RequestMapping("/student/dataConverter")
public class HeathDataConverterContoller {
	...
	public ModelAndView showUpload(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/student/dataConverter/showUpload", modelMap);
	}
